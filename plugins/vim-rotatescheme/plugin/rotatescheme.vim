...
let s:choices = ['afterglow', 'anderson', 'ayu', 'apprentice', 'atom-dark-256', 'codedark', 'dracula' ,'molokai' ,'molokayo', 'monokai', 'papercolor','pencil', 'seoul256-light', 'seoul256', 'space-vim-dark']
